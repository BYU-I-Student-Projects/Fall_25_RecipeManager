          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 4,
                children: [
                  _buildInfoItem(Icons.schedule, '${recipe.prepTime + recipe.cookTime} min'),
                  _buildInfoItem(Icons.restaurant, '${recipe.servings} servings'),
                  _buildInfoItem(Icons.local_fire_department, '${recipe.calPerServing} cal'),
                ],
              ),
              
              // Meal Types
              if (recipe.mealTypes.isNotEmpty && 
                  !(recipe.mealTypes.length == 1 && recipe.mealTypes[0] == 'All'))
                Padding(
