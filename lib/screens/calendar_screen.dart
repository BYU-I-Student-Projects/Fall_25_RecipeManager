            ...
            children: [
              ...
              TableCalendar(
                ...
                onDaySelected: (selectedDay, focusedDay) {
                  // Logic Update: Always update the state and show dialog.
                  // Only clear the list if the day physically changed.
                  setState(() {
                    if (!isSameDay(_selectedDay, selectedDay)) {
                      // Reset category/meal selections only if picking a new day
                      for (var i = 0; i < _selectedCategories.length; i++) {
                  ...
                  // Show the dialog immediately (removed Future.delayed)
